...
// primary
// BNF文法規則: '(' equation ')' | NUMBER | IDENTIFIER | STRING
...
// statement
// BNF文法規則: 'if' equation block [ 'else' block ] | 'while' equation block | simple
